...
一般的な mate–counit 恒等式により、最初の生成射消去順序、すなわち厳密な逆生成射の後にその前向き生成射を合成する場合の公開合成則も証明されました。これらのデータを標的 strong transformation にするには、反対の「前向きの後に逆射」の消去順序がまだ必要です。
