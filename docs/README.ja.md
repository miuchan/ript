...
| `Ript.Examples.TwoDimensionalWalkingLocalization.generalLiftMapCompInverseForward_naturality_right` | 完全な逆射後前向き消去 compositor は、右の前向き因子上の保持座標 2-射について自然です。 |
| `Ript.Examples.TwoDimensionalWalkingLocalization.generalLiftMapCompInverseForward_naturality_left` | 完全な逆射後前向き消去 compositor は、左の逆射因子上の保持座標 2-射について自然です。 |
