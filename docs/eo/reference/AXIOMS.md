...
[日本語](../../ja/reference/AXIOMS.md) · [Esperanto](AXIOMS.md)

La tabelo registras la realan eliron de
`lake env lean Ript/Audit/AxiomChecks.lean`. La radika
[`AXIOMS.md`](../../../AXIOMS.md) estas la maŝina fonto uzata de la validigaj
skriptoj. Deklarnomoj, ekzaktaj kernaj eliroj kaj fontdosieroj estas sinkronigataj
per `scripts/sync-doc-reference-tables.sh` kaj ne estu mane redaktataj.

| Teoremo aŭ deklaro | Kerna eliro | Fonto |
| --- | --- | --- |
...
| `CategoryTheory.Bicategory.MarkedZigzag.Presented.LocalInterpretation.descend` | `[Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagMappingPresentation.lean` |
...
| `Ript.Higher.CostExactZigzag.inclusion_obj_surjective` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzag.lean` |
...
| `Ript.Higher.CostExactZigzagMappingSpace.comparison` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
| `Ript.Higher.CostExactZigzagMappingSpace.comparisonNerveEquivalence` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
| `Ript.Higher.CostExactZigzagMappingSpace.comparisonHomotopyEquivalence` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
...
| `Ript.Higher.CostExactZigzagMappingSpace.generatedLinearEquivalence` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
| `Ript.Higher.CostExactZigzagMappingSpace.generatedLinearNerveEquivalence` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
| `Ript.Higher.CostExactZigzagMappingSpace.generatedLinearHomotopyEquivalence` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
| `Ript.Higher.CostExactZigzagMappingSpace.generatedTargetEquivalence` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
| `Ript.Higher.CostExactZigzagMappingSpace.generatedTargetNerveEquivalence` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
| `Ript.Higher.CostExactZigzagMappingSpace.generatedTargetHomotopyEquivalence` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
| `Ript.Higher.CostExactZigzagMappingSpace.generatedTargetComparison_factorization` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
...
| `CategoryTheory.Bicategory.MarkedZigzag.AlignedCell.toHom_identity` | `[Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.AlignedCell.toHom_vcomp` | `[propext, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.AlignedCell.width_append` | `[propext]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.ColumnRefinement.target_length_eq_source_length_add_widthChange` | `[propext, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.ColumnRefinement.widthChange_reverse` | `[propext, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
...
| `CategoryTheory.Bicategory.MarkedZigzag.ColumnRefinement.toHom_eq_toIso_hom` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.ColumnRefinement.toIso_reverse` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.CommonRefinement.related_trans` | `none` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.CommonRefinement.quotientMk_eq_iff_related` | `[propext, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.CommonRefinement.quotientMk_eq_semanticIso` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.CommonRefinement.quotientFunctor_full` | `[propext, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.CommonRefinement.quotientFunctor_faithful` | `[propext, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.CommonRefinement.quotientFunctor_essSurj` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.CommonRefinement.quotientEquivalence` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.CommonRefinement.rowObjectIsGroupoid` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.RefinementPath.rel_vcomp` | `[Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.RefinementPath.comp_reverseHom` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.RefinementPath.reverseHom_comp` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.RefinementPath.isGroupoid` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.RefinementPath.semanticFunctor_faithful` | `[Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.RefinementPath.semanticFunctor_essSurj` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
...
| `CategoryTheory.Bicategory.MarkedZigzag.LinearWord.rightAssociatedPair_coherence` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagLinearHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.LinearWord.normalizationIso_twoAtoms_hom` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagLinearHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.LinearWord.normalizationIso_twoAtoms_inv` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagLinearHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.HammockPath.normalizedCellHom_sourceComp` | `[propext, Classical.choice, Quot.sound]` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagAlignedHammock.lean` |
...
| `CategoryTheory.Bicategory.MarkedZigzag.LinearWord.toWord_nil` | `none` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagLinearHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.LinearWord.flatten_nil` | `none` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagLinearHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.LinearWord.append_nil` | `none` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagLinearHammock.lean` |
| `CategoryTheory.Bicategory.MarkedZigzag.LinearWord.append_assoc` | `none` | `Ript/ForMathlib/CategoryTheory/Bicategory/MarkedZigzagLinearHammock.lean` |
...
| `Ript.Higher.CostExactZigzagMappingSpace.commonRefinementCore` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
| `Ript.Higher.CostExactZigzagMappingSpace.thinRefinementNerveEquivalence` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
| `Ript.Higher.CostExactZigzagMappingSpace.thinRefinementHomotopyEquivalence` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
| `Ript.Higher.CostExactZigzagMappingSpace.thinRefinementNerveCore` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagMappingSpace.lean` |
...
| `Ript.Higher.CostExactZigzagGlobalComparison.homotopyLocalizationFunctor_obj_surjective` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagGlobalComparison.lean` |
...
| `Ript.Higher.CostExactZigzagGlobalComparison.linearHammockDwyerKanCore` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagGlobalComparison.lean` |
| `Ript.Higher.CostExactZigzagGlobalComparison.GeneratedHammockDwyerKanCore` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagGlobalComparison.lean` |
| `Ript.Higher.CostExactZigzagGlobalComparison.generatedHammockDwyerKanCore` | `[propext, Classical.choice, Quot.sound]` | `Ript/Higher/CostExactZigzagGlobalComparison.lean` |
...
## Kiel legi la rezultojn

- `none` signifas, ke la deklaro ne dependas de aksiomoj;
- `propext` estas propozicia etendeco de Lean;
- `Quot.sound` venas de la kvocienta pruva tavolo;
- `Classical.choice` plejparte venas de la finia, kategoria, mezura, skeleta,
  Yoneda-a kaj simplicia infrastrukturo de Mathlib;
- ne ekzistas projektspecifaj aksiomoj, fid-evitoj aŭ pruvtruoj.

La rulebla finia kerno restas aparta de semantikaj tavoloj, kiuj bezonas
klasikan elekton. Aperanta `Classical.choice` ne signifas, ke elektita
reprezentanto fariĝas rultempa datumo.

## Ĝisdatiga procedo

Post aldono aŭ ŝanĝo de ĉefa teoremo, ĝisdatigu la auditmodulon kaj radikan
registron, rulu `./scripts/sync-doc-reference-tables.sh`, kaj poste
