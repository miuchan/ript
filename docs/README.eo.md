...
tut-saga kondiĉo estas 2-ĉele natura trans sia identeca branĉo. Nur kunmeta
kohero restas antaŭ ol ĉi tiuj datumoj formas celan fortan transformon.
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_naturality` | La publika tut-saga kondiĉo estas natura en ĉiu cela 2-ĉelo, inkluzive sian striktan identecan branĉon; kunmeta kohero restas malfermita. |
