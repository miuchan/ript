...
de la libere aldonitaj inversaj sagoj. Kongrueco inter la speciala identeca
branĉo de la publika kondiĉo kaj la finpunkta kondiĉo, kaj kunmeta kohero,
restas malfermitaj.
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_id` | La publika tut-saga kandidato plenumas la kompletan identecan koherleĝon de forta transformo; 2-ĉela kongrueco ĉe la identeca branĉo kaj kunmeta kohero restas malfermitaj. |
