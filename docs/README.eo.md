...
de la du antaŭaj faktorigoj estas kompilitaj. La restanta mate-glita leĝo estas
precize registrita kiel `FORMALIZED_BUT_UNPROVED` propozicio. Antaŭ ol ĉi tiuj
datumoj formas celan fortan transformon, restas tiu leĝo kaj la du generatoraj
nuligaj ordoj.
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_comp_forward` | Kanona antaŭa-antaŭa kunmeta kohero validas kun arbitraj konservitaj koordinatoj; miksitaj inversaj okazoj restas malfermitaj. |
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_comp_inverseGenerator_retained_public` | La sama invers-generatora/konservita kunmeta leĝo validas per la publikaj kondiĉoj ĉe ambaŭ faktoroj; aliaj miksitaj inversaj ordoj restas malfermitaj. |
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.LiftedStrongTransRetainedInverseCompositionCoherence` | La preciza publika kunmeta propozicio por konservita kondiĉo sekvata de inversa generatoro; `FORMALIZED_BUT_UNPROVED`. |
