...
kunmetaĵo. Antaŭ ol ĉi tiuj datumoj formas celan fortan transformon, restas la aliaj
publik-faktoraj miksitaj okazoj kun la libere aldonita inverso.
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_comp_inverseGenerator_retained` | Konstrunivela kunmeta kohero validas por la invers-generatora mate sekvata de ĉiu konservit-koordinata kondiĉo; publik-faktoraj miksitaj leĝoj restas malfermitaj. |
