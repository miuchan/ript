...
Kongrua ekzakta reŝarga kanalo nun fermas tiun atestilon en plenumeblan
dupaŝan ciklon. Ĝi hazardigas la viŝitan memoron reen al ekvilibro, levas la
puran baterion de malalta al alta per ekzakte `log 2 / β`, kaj produktas la
spuron `justa/alta → viŝita/malalta → justa/alta`. La signitaj memoraj kaj
bateriaj bilancoj nuliĝas, do la konstruo pruvas reŝargon kaj statrevenon sen
aserti netan laboron.
...
ordinaran homotopikan 1-kategorion de la modeldukategorio. La krudaj
kost-reflektaj sagoj nun estas apartigitaj de sia eksplicita saturiĝo laŭ
inversigeblaj 2-ĉeloj; teoremo precize identigas tiun dukategorian markon kun
la markitaj klasoj en la homotopikategorio. La Gabriel--Zisman-konstruo de
Mathlib tiam donas veran `Functor.IsLocalization`-instancon kaj la
funktorkategorian universalan econ. La kanona ponto de la pli alta strukturo
estas formaligita kiel pseŭdofunktoro de la `Pith` de Mathlib—la maksimuma
loke grupoida parto de la modeldukategorio—al la loke diskreta lokalizo, kaj
ĉiu saturite markita sago pruviĝas mapita al izomorfio. Nulkosta diskreta
markita sago ne estas inversigebla antaŭ lokalizo, do vera formala inverso
estas aldonata. Aparte, finia determinisma forĵeto estas konkreta
neinversigebla monoida 2-ĉelo kies finpunktoj restas malsamaj en la
homotopikategorio. Aldone, ĉiu pseŭdofunktoro de la plena modeldukategorio al
loke diskreta celo pruviĝas identigi la bildojn de tiuj finpunktoj. Ript ankaŭ
...
ekvivalento, do identeco ne povas esti la kost-ekzakta lokalizo de Ript. La unua
...
havas eksplicitan faktoradon tra la celo. Antaŭkunmeto estas nun ekvivalento en
ĉiu loka kategorio de fortaj transformoj kaj modifoj. Fontaj modifaj komponantoj
leviĝas trans la libere aldonitan inverson; fonta forta transformo determinas
celajn objektajn komponantojn kaj kanonajn naturec-izomorfiojn ĉe ĉiu cela
1-morfio. Mate-identoj traktas ambaŭ generatorajn nuligajn ordojn, kaj transporto
laŭ la asocianto kune kun invarianto sub faktoraj izomorfioj etendas la rezulton
al ambaŭ finpunkt-ŝanĝaj nuligoj kun arbitraj konservitaj koordinatoj. Maldikeco
de la marŝanta kompletigo reduktas ĉiun alian celan kunmetaĵon al unu el tiuj
pruvitaj okazoj. La datumoj formas veran celan fortan transformon, kaj
inversigebla modifo identigas ĝian limigon kun la origina fonta transformo. Kun
la jam pruvita plena fideleco tio donas lokan esencan surĵetecon kaj lokan
ekvivalenton.
...
inverson al la efektiva inverso de la bildo de la genera sago. La du komponantoj
nun ankaŭ kombiniĝas: ĉiu apartigebla miks-koordinata pseŭdofunktoro `K × H`,
kun arbitra grupoid-valora lokalizata komponanto kaj arbitra konservit-koordinata
komponanto, faktoriĝas tra la celo; ĝia levo ĝuste interpretas la formalan
inverson, kaj kun identeca konservita komponanto ĝi ankoraŭ detektas
neinversigeblan Bulean forĵeton. Mark-inversigo kaj faktorado de fontaj
pseŭdofunktoroj estas nun pruvite invariantaj sub adjunkta ekvivalento. La
rezulto do kovras la tutan repletan fermon de la apartigebla familio, inkluzive
realigojn kiuj ne estas difine komponantaj produktoj. Eĉ ekster tiu fermo,
...
La plena antaŭa-antaŭa komponilo, ambaŭ miksitaj komponiloj (inversa poste
konservita, kaj konservita poste inversa), kaj ambaŭ nuligaj komponiloj
(inversa poste antaŭa, kaj antaŭa poste inversa) estas pruvite naturaj en
...
Dwyer--Kan-a, simplicia aŭ Rezk-lokalizo.
...
Rezk-kompletigo estas farata. La sekva fundamento de la Rezk-vojo ankaŭ nun
kompiliĝas: vera klasifika diagramo konservas kunmeteblajn ĉenojn kaj iliajn
...
instanco kaj konstruo de pseŭdofunktoro por la tuta rimed-proceza dukategorio
plenumanta la kompilitan lokalizan universalan predikaton restas malfermitaj.
...
La finia geometrio nun estas eksplicita. `independentGarblingLaw` prezentas
ĉiun stokastan malprecigilon kiel ekzaktan `ℚ≥0`-distribuon super determinismaj
posttraktadoj, kaj `deterministicMixtureDominates_iff` identigas superadon kun
racia-simpleksa realigebleco. `RationalGarblingSeparator` estas signita racia
...
ekziston aŭ saturiĝon per si mem.

`BathAssistedTransition` aparte registras la ekzaktajn finpunktojn de sistemo,
bano kaj baterio. La ĝenerala teoremo pagigas sisteman liberenergian kreskon
per la sumo de la ban- kaj bateri-liberenergiaj malkreskoj. Ekzakta reveno de
la bano nuligas la banan terminon; tamen bateria entropineŭtraleco plu necesas
antaŭ ol nomi la perdon mekanika laboro.

`Ript.Examples.ExplicitBathErasure` donas veran finian ekzisto- kaj
saturiĝ-atestilon. La supra determinisma permutacio mapas
`(justa, justa, viŝita)` ekzakte al `(viŝita, justa, justa)`, konservas la
...
`Ript.Examples.ExactWorkCycle` donas la kongruan inversan reŝargan paŝon. Ĝia
Gibbs-konserva kanalo ekzakte mapas
`(viŝita memoro, pura malalta baterio)` al
`(justa memoro, pura alta baterio)`; la `log 2 / β` da libera energio liberigita
per hazardigo de la memoro pagas ekzakte la saman baterian energikreskon. La
dupaŝa protokolo havas la ekzaktan spuron
...
### 17. Fundamento de la Rezk-klasifika diagramo

La strikta nervo havas nur unu simplician direkton kaj ne konservas naturajn
transformojn inter tutaj kunmeteblaj ĉenoj. La nova konstruo eksplicite
konservas duan direkton:
...
En ekstera grado `n`, la kategorio estas `ComposableArrows M.Object n`: ĝiaj
objektoj estas funktoroj `Fin (n + 1) ⥤ M.Object`, ĝiaj morfioj estas naturaj
transformoj, kaj eksteraj facoj kaj degeneroj agas per antaŭkunmeto. Apliki
`CategoryTheory.nerveFunctor` nivele produktas veran dusimplician klasifikan
diagramon, ne alian nomon por la ordinara nervo.
...
Vertikalaj eĝoj estas precize naturaj transformoj inter ordinaraj
`n`-simplaĵoj; ĉiu komponanto estas inversigebla interna idento. La kodo
eksplicite konstruas inversajn transformojn kaj eĝojn, pruvas ambaŭ nuligajn
...
reala paŝo preter la strikta nervo. Ĉiu horizontala sago estas inversigebla, do
la ekvivalentospaco estas la tuta ekstera unua grado. La efektiva ekstera nula
...
| `Ript.Models.Decision.Separation.DecisionSeparationCertificate.not_dominates` | Ĉiu strikta finia decid-atestilo forigas ĉiujn stokastajn malprecigojn. |
| `Ript.Models.Decision.Separation.not_finiteDecisionOrder_iff_certificate` | Malsukceso de universala finia riskordo ekvivalentas al konkreta atestilo. |
...
| `Ript.Models.Thermal.FiniteClosedProtocol.trace_twoSteps` | Atestita paro de iro kaj reveno havas ekzaktan fermitan tri-statan spuron. |
| `Ript.Examples.ExactWorkCycle.exactWorkRechargeChannel_recharges` | La plenumebla reŝarga kanalo ekzakte mapas viŝita/malalta al justa/alta. |
| `Ript.Examples.ExactWorkCycle.exactWorkRecharge_saturates_landauer_work` | Liberigo de memora libera energio ekzakte pagas la baterian energikreskon. |
| `Ript.Examples.ExactWorkCycle.exactWorkCycle_trace` | La fermita ciklo sekvas `justa/alta → viŝita/malalta → justa/alta`. |
| `Ript.Examples.ExactWorkCycle.exactWorkCycle_returns` | Viŝo sekvata de reŝargo ekzakte redonas la kompletan memor-baterian staton. |
| `Ript.Examples.ExactWorkCycle.exactWorkCycle_batteryEnergy_balanced` | La signitaj bateriaj energioŝanĝoj de malŝargo kaj reŝargo sumiĝas al nul. |
| `Ript.Examples.ExactWorkCycle.exactWorkCycle_systemFreeEnergy_balanced` | La signitaj ŝanĝoj de memora libera energio sumiĝas al nul. |
...
| `CategoryTheory.LocallyDiscrete.equivalenceOfIsIso` | Ordinara kategoria izomorfio induktas adjunktan ekvivalenton en la rilata loke diskreta dukategorio. |
| `CategoryTheory.Bicategory.MorphismProperty.locallyDiscrete_isInvertedBy` | Ordinara inversigo transportiĝas al dukategoria adjunkt-ekvivalenta inversigo per la induktita pseŭdofunktoro. |
...
| `CategoryTheory.Bicategory.mateEquiv_unit` | La fonta unit sekvata de mate kaj la inversa cela unit donas la kanonan unuigilan komparon. |
...
| `CategoryTheory.Pseudofunctor.StrongTrans.hom_comp_inverseNaturalityIso_unit` | Antaŭa kondiĉo sekvata de sia mate-derivita inverso transportiĝas laŭ la inversa unit al la kanona identeca kondiĉo. |
...
| `Ript.Examples.WalkingLocalization.inclusionFunctor_isLocalization` | La enigo de la marŝanta sago en ĝian liberan grupoidon estas vera ordinara Mathlib-lokalizo. |
| `Ript.Examples.WalkingLocalization.inclusion_map_arrow_comp_inverse` | La genera sago sekvata de sia nove aldonita inverso estas la idento. |
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.separableMixedSource_has_factorization` | Por arbitraj grupoid-valora `K` kaj konservit-koordinata `H`, la apartigebla miks-pseŭdofunktoro `K × H` faktoriĝas tra la celo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.repleteSeparableMixedSource_inverts_and_factors` | Ĉiu pseŭdofunktoro adjunkte ekvivalenta al apartigebla miks-fonto aŭtomate inversigas la markon kaj faktoriĝas tra la celo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.separableMixedLift_map_inverse_fst` | La miksita levo mapas la formalan inverson en la unua koordinato al la efektiva inverso de la bildo de la genera sago. |
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.generalLiftMapCompInverseForward_naturality_right` | La plena inversa-poste-antaŭa nuliga komponilo estas natura rilate konservit-koordinatajn 2-ĉelojn sur sia dekstra antaŭa faktoro. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.generalLiftMapCompInverseForward_naturality_left` | La plena inversa-poste-antaŭa nuliga komponilo estas natura rilate konservit-koordinatajn 2-ĉelojn sur sia maldekstra inversa faktoro. |
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.inclusionLocalPrecompositionFullyFaithful` | Antaŭkunmeto estas plene fidela en ĉiu loka kategorio de fortaj transformoj kaj modifoj. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTrans` | Ĉiu fonta forta transformo etendiĝas al vera cela forta transformo kun ĉiuj identecaj, naturecaj kaj kunmetaj leĝoj pruvitaj. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransRestrictionIso` | Limigi la levitan celan fortan transformon reakiras la originan fontan transformon ĝis inversigebla modifo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.inclusion_localPrecomposition_essSurj` | Antaŭkunmeto estas esence surĵeta je objektoj en ĉiu loka kategorio. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.inclusion_localPrecomposition_isEquivalence` | Antaŭkunmeto estas ekvivalento en ĉiu loka kategorio de fortaj transformoj kaj modifoj. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransForwardNaturality_eq_source` | Antaŭaj kondiĉoj kun arbitraj konservitaj koordinatoj estas difine la originaj fontaj fort-naturecaj kondiĉoj. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransForwardNaturality_naturality` | Antaŭaj levitaj kondiĉoj estas naturaj en ĉiu konservit-koordinata 2-ĉelo. |
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransInverseNaturality_naturality` | Kondiĉoj ĉe libere aldonitaj inversaj sagoj estas naturaj en ĉiu konservit-koordinata 2-ĉelo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransEndpointNaturality_inverse_of_not_le` | Vere inversa finpunkt-normaligita kondiĉo estas ĝuste la inversa mate-kondiĉo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransEndpointNaturality_inclusion` | Sur ĉiu sago en la bildo de la inkludo, finpunkta normaligo redonas la originan fontan kondiĉon. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransEndpointNaturality_naturality` | Finpunkta normaligo donas 2-ĉele naturan kondiĉon por ĉiu cela sago, kovrante kaj antaŭajn kaj inversajn branĉojn. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransEndpointNaturality_iso` | Finpunkt-normaligitaj kondiĉoj transportiĝas kanone laŭ ĉiu cela 2-izomorfio. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransEndpointNaturality_inverseComposite` | La eksplicita kunmetaĵo de la invers-generatora mate kun arbitra konservita kondiĉo estas ĝuste la finpunkt-normaligita kondiĉo ĉe la kruda kunmetaĵo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransEndpointNaturality_comp_inclusion` | Finpunkt-normaligitaj kondiĉoj plenumas kunmetan koheron por ĉiu paro de sagoj en la bildo de la inkludo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransEndpointNaturality_id_eq` | La finpunkt-normaligita identeca kondiĉo egalas la kanonan identecan kondiĉon de forta transformo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransForwardIdentityNaturality_transport` | Transporti fontan naturecon ĉe la kanona antaŭa idento laŭ la unu-komparo de la inkludo donas la celan identecan kondiĉon. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality` | Finpunkta normalformo kun kanona identeca branĉo elektas kandidatan fort-naturecan izomorfion por ĉiu cela 1-morfio. |
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransGeneratorCancellation_unit` | Antaŭ-generatora natureco sekvata de la inversa generatoro transportiĝas laŭ la inversa unit al la kanona identeca kondiĉo. |
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_compIso_generator_inverseGenerator` | Injekteco de invers-unit-transporto identigas la kontraŭordan publikan nuligan kandidaton kun la publika kondiĉo de la kruda kunmetaĵo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_comp_generator_inverseGenerator` | La publika kunmeta kohero validas por strikta antaŭa generatoro sekvata de sia inverso. |
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_comp_inclusion` | La publikaj kondiĉoj plenumas kunmetan koheron por ĉiu paro de sagoj en la bildo de la inkludo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_comp_forward` | Kanona antaŭa-antaŭa kunmeta kohero validas kun arbitraj konservitaj koordinatoj. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_generatorRetained_transport` | Antaŭa generatoro sekvata de konservita kondiĉo transportiĝas al la publika kombinita antaŭa kondiĉo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_retainedGenerator_transport` | Konservita kondiĉo sekvata de la antaŭa generatoro transportiĝas al la sama publika antaŭa kondiĉo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_comp_inverseGenerator_retained` | Konstrunivela kunmeta kohero validas por la invers-generatora mate sekvata de ĉiu konservit-koordinata kondiĉo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_comp_inverseGenerator_retained_public` | La invers-generatora/konservita kunmeta leĝo validas per la publikaj kondiĉoj ĉe ambaŭ faktoroj. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_inverseGeneratorRetained_transport` | La publika invers-generatora/konservita kunmetaĵo transportiĝas al la publika kondiĉo de la kanona inversa sago. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransRetainedInverse_sliding` | La kandidato kun konservita kondiĉo sekvata de la inversa generatoro glitas al la kandidato kun la inversa generatoro sekvata de konservita kondiĉo per la kanona mate-komparo. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.LiftedStrongTransRetainedInverseCompositionCoherence` | La preciza publika kunmeta propozicio por konservita kondiĉo sekvata de inversa generatoro; la sekva teoremo ĝin pruvas. |
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_comp_retainedInverse` | Pruvas la publikan kunmetan propozicion pri konservita kondiĉo sekvata de inversa generatoro por ĉiu marŝanta sago. |
...
| `Ript.Univalent.UniverseModel.interfaceClassifyingDiagramVerticalTransformation_comp_inverse` | Vertikala transformo sekvata de sia inverso estas la idento. |
| `Ript.Univalent.UniverseModel.interfaceClassifyingDiagramVerticalTransformation_inverse_comp` | La inverso sekvata de la vertikala transformo estas la idento. |
| `Ript.Univalent.UniverseModel.interfaceClassifyingDiagramVerticalEdgeComponent_isIso` | Ĉiu komponanto de vertikala eĝo estas inversigebla interna idento. |
| `Ript.Univalent.UniverseModel.interfaceClassifyingDiagramVerticalEdgeEquiv_inverseEdge` | Inversigi vertikalan eĝon malkodiĝas ekzakte al la inversa natura transformo. |
...
| 10, ordinara modellokalizo | Kost-ekzakta marko saturita laŭ inversigeblaj 2-ĉeloj, preciza malsuprenigo al la homotopika 1-kategorio, kanona `Pith`-pseŭdofunktoro, Mathlib-lokaliza universala eco, neinversigeblaj markita sago kaj modela 2-ĉelo | **PROVED** |
...
| 12, pli-alta lokaliza specifo | Mark-inversigo al adjunktaj ekvivalentoj, pseŭdofunktora antaŭkunmeto, identecaj kaj marŝant-sagaj bazkonstruoj, finpunkta normalformo/maldikeco/kodiskreta klasifiko de la marŝanta kompletigo, neloke-diskreta parametrigita konstruo kun konservit-koordinataj, lokalizat-koordinataj, apartigeblaj miks-koordinataj kaj adjunkt-ekvivalentaj replet-fermaj faktoradfamilioj, lokaj antaŭkunmetaj ekvivalentoj kaj arbitraj mark-inversigaj celaj `PrelaxFunctor`-agoj, kost-ekzakta specialigo kaj konkretaj obstrukcoj | **PROVED** |
...
`Ript/Examples/StochasticSeparation.lean` apartigas du vere stokastajn Buleajn
eksperimentojn. Rekta uzo de `3/4`-preciza brua observo havas ekzaktan riskon
`1/4`, dum ĉiu regulo bazita sur sendependa justa observo havas riskon `1/2`.
La pakita atestilo uzas la ĝeneralan ĝustecan teoremon por forigi ĉiun stokastan
malprecigon. Tri ordinaraj kontraktoj `#eval decide` kontrolas ambaŭ riskojn kaj
ilian striktan ordon.
...
-- aŭ, por la ekzakta malpreciga simplekso kaj racia apartiga redukto:
...
-- aŭ, por plenumebla fermita viŝa–reŝarga laborciklo:
...
-- aŭ, por la dudimensia Rezk-klasifika-diagrama fundamento:
...
- [ ] Konstrui plenan rimed-procezan pseŭdofunktoron plenumantan la kompilitan dukategorian lokalizan predikaton kaj establi Mathlib-denaskan simplician malfort-ekvivalentan/norman kompleta-Segal-an komparon
