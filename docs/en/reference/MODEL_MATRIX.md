...
and has a unique compatible quotient lift. A derived or hammock homotopical
characterization, weak-equivalence packaging, and the global complete-
Segal/Rezk theorem remain open. These layers do not add `Equiv α β → α = β`
and are not a complete presheaf model.
