...
degeneracies uniformly. Actual target prism-face projection gluing and the
global complete-Segal/Rezk weak-equivalence theorem remain open. These
layers do not add `Equiv α β → α = β` and are not a complete presheaf
model.
