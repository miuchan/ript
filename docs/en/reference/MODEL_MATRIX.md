...
`LinearHammockDwyerKanCore`. Comparison with a classical arbitrary-grid
hammock and standard weak-equivalence packaging remain open. These layers do
not add `Equiv α β → α = β` and are not a complete presheaf model.
