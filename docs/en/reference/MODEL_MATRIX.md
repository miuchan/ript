...
strictly extends the refinement path nerve, and is closed under normalized
...
closure are proved; all marked pair, unitor, and associator cases are proved
too. Every raw cell is unconditionally normalizable, every linear quotient
2-cell has a generated path representative, and generated-path semantics is a
categorical and nerve equivalence with an explicit homotopy inverse. Its
