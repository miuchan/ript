...
have explicit widths, horizontal append, exact identity/vertical-composition
interpretation, and arbitrary-height grid reconstruction with exact rows and
edges. General column refinements, reduced-hammock invariance, and standard
