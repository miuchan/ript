...
source 规范化的 forward 结合律核心已经编译；canonical target comparison 方块、它在任意
target action 下的像以及 endpoint-transport 结合律也已经编译。把这些层组合成完整 forward
分支、其余 oplax 结合律情形、pseudofunctor 封装和最终伴随等价仍未完成。权威边界见
