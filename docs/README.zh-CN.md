...
| 8 | 有限平衡系统、Gibbs 实现、KL/自由能恒等式、Gibbs-preserving 单调性与具体有限 KL 数据处理 | **PROVED** |
...
| 有限热系统 | Gibbs-preserving 范畴 | 积 bifunctor | 精确状态/信道可执行；Gibbs/KL/自由能语义不可计算 | 指定平衡态、认证的实数 Gibbs 实现、KL/自由能恒等式与自由能差单调性 |
