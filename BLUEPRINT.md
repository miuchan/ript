...
| 12 (global cost-exact complete-Segal/Rezk equivalence) | Quotient the elementary forward and marked-pair refinements by general common-refinement spans and competing move coherence, prove reduced-hammock moves and their homotopical invariance (or compare them to another accepted derived mapping-space construction), connect that comparison to a standard weak-equivalence interface, and finish the standard Dwyer--Kan/Rezk weak-equivalence and completeness theorem | OPEN_RESEARCH |
