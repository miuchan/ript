...
canonical forward target arrow.  This covers all target arrows inherited
from the walking source; the freely adjoined inverse remains the separate
reverse-arrow unit branch. -/
