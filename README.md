...
freely adjoined inverse must still be established before these data form a
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_comp_inverseGenerator_retained` | Constructor-level composition coherence holds for the inverse-generator mate followed by any retained-coordinate constraint; public-factor mixed laws remain. |
