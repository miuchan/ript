...
2-cell-natural across its identity branch. Only the composition law remains
before these data form a target strong transformation.
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_naturality` | The public all-arrow constraint is natural in every target 2-morphism, including its strict-identity branch; composition coherence remains open. |
