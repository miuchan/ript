...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality` | Endpoint normalization selects a candidate strong-naturality isomorphism for every target 1-morphism; the three coherence laws remain open. |
