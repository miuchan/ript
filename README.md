...
arrows. Compatibility with the public constraint's special identity branch
and the composition law remain before these data form a target strong
transformation.
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_id` | The public all-arrow candidate satisfies the full strong-transformation identity coherence law; identity-branch 2-cell compatibility and composition coherence remain open. |
