...
covers all target arrows. Naturality in 2-cells plus the identity and
composition laws remain before these data form a target strong transformation.
...
| `Ript.Examples.TwoDimensionalWalkingLocalization.liftedStrongTransNaturality_id` | The all-arrow candidate satisfies the full strong-transformation identity coherence law; inverse-arrow 2-cell naturality and composition coherence remain open. |
