...
equality. The remaining engineering/theory gap is the quotient mapping
category and nerve together with critical-pair coherence, reduced-hammock
invariance, and standard weak-equivalence packaging. The zero-truncated part
is now closed: the thin common-refinement groupoid is categorically equivalent
to the discrete row quotient, and the nerve map has an explicit simplicial
homotopy inverse. The remaining nerve gap is specifically the non-thin path
category retaining competing refinements. These
